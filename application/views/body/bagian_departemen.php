...
<a href="<?php echo base_url();?>bagian_departemen/add" style="text-decoration:none">Add Data Sub Department</a></div>
					<div class="panel-body">
						<table data-toggle="table" data-show-refresh="false" data-show-toggle="true" data-show-columns="true" data-search="true"  data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    <thead>
						    <tr>
						        <th data-field="no" data-sortable="true" width="10px">No</th>
						        <th data-field="id" data-sortable="true">Department</th>
						        <th data-field="bagian" data-sortable="true">Sub Department</th>
						         <th >Action</th>
						    </tr>
                            </thead>
                            <tbody>
